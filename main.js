...
function setTodoList () {
  ...
  populateTodoList((0,_storage__WEBPACK_IMPORTED_MODULE_2__.getProjectFromStorage)(key));
...
function populateProjects (listOfProjects) {
...
function populateTodoList (project) {
...
function makeTodoItemCard (todoItem, currentListItem) {
  ...
  date.textContent =
    `Due: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(dateValue, 'E dd/MM/yyyy')}`;
...
const contextGetter = function getCurrentTodoAndProjFromDom(card) {
  ...
  const project = (0,_storage__WEBPACK_IMPORTED_MODULE_2__.getProjectFromStorage)(projectName);
...
const submitDate = function dateEnteredOnTodoItem(event) {
  ...
  const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(date, 'E dd/MM/yyyy');
...
function projSubmit(event) {
  ...
  let index = 0;
  const storageProjects = (0,_storage__WEBPACK_IMPORTED_MODULE_2__.getAllProjectsFromStorage)();
  ...
  const newProj = (0,_projects__WEBPACK_IMPORTED_MODULE_0__.createNewProject)(projInput, index);

  populateProjects((0,_storage__WEBPACK_IMPORTED_MODULE_2__.getAllProjectsFromStorage)());
...
function todoSubmit(event) {
  ...
  const project = (0,_storage__WEBPACK_IMPORTED_MODULE_2__.getProjectFromStorage)(key);
  ...
  const newTodo = new _todo__WEBPACK_IMPORTED_MODULE_1__.Todo(title,"", date, priority, "false", index);
...
function projOnClick(event) {
  ...
  if (event.target.class == "project-expand") {
    ...
    const project = new _projects__WEBPACK_IMPORTED_MODULE_0__.Project (key, (0,_storage__WEBPACK_IMPORTED_MODULE_2__.getContentFromStorage)(key), (0,_storage__WEBPACK_IMPORTED_MODULE_2__.getIndexFromStorage)(key));
...
const fill = function fillDefault() {
  ...
  const defaultTodo2 =new _todo__WEBPACK_IMPORTED_MODULE_0__.Todo("Click the circle to delete the item", "Example Description", date, "Tomato", "false", "1");
  ...
  const defaultProj2 = new _projects__WEBPACK_IMPORTED_MODULE_1__.Project("Click the square to delete the Project",[defaultTodo3], 1);
